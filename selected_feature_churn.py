...
We then produce:
  1) A tidy CSV summary: results/feature_churn_summary.csv
  2) Stacked bar charts per group under results/feature_churn_plots/

Usage:
  python feature_churn_viz.py \
    --csv results/selected_features.csv \
    --outdir results
...
if __name__ == "__main__":
    ...
    outdir = "results"
    os.makedirs(outdir, exist_ok=True)
    plots_dir = os.path.join(outdir, "feature_churn_plots")
    ...
    summary_csv = os.path.join(outdir, "feature_churn_summary.csv")
