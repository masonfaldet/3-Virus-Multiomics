...
from query_and_preprocess import make_dataset, make_preprocess_pipeline
...
if __name__ == "__main__":
    ...
    p = pca_intersection(
        csv_path="results/selected_features.csv",
        root="parquets",
        modality="metabolite",
        polarity="-",
        condition="DENV",
        times=None,         # or [0,5,7,14,21]
        outdir="results/pca_plots",
        min_features=2,
    )
    print("Saved:", p)
